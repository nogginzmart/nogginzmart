...
let track_list = [
  {
    name: "Your Name, Please - Earthbound OST",
    path: "https://nogginzmart.neocities.org/music/pollresults1.mp3",
  },
  {
    name:"Boy Meets Girl - Earthbound OST",
    path:"https://nogginzmart.neocities.org/music/pollresults2.ogg",
  },
  {
    name:"Ness Bike - Earthbound OST",
    path:"https://nogginzmart.neocities.org/music/pollresults3.mp3",
  },
  {
    name:"Dead End Chaos Theater - Earthbound OST",
    path:"https://nogginzmart.neocities.org/music/earthbound4.ogg",
  },
  {
    name:"Runaway Five Have Left The Buildng! - Earthbound OST",
    path:"https://nogginzmart.neocities.org/music/Runaway%20Five%20Left%20the%20Building!.ogg",
  },
];
//
//
...
function copyThree() {
  ...
  navigator.clipboard.writeText(copyText.value);
  alert("Copied successfully! Theme: Sappho");
}

function copyFour() {
  var copyText = document.getElementById("inputFour");
  navigator.clipboard.writeText(copyText.value);
  alert("Copied successfully! Theme: violents");
}

function copyFive() {
  var copyText = document.getElementById("inputFive");
  navigator.clipboard.writeText(copyText.value);
  alert("Copied successfully! Theme: flags");
}
...
document.addEventListener("DOMContentLoaded", function () {
  // === CONFIGURATION ===
  const FORM_ID = "1FAIpQLScRy0oXkEbM61xCWUFEVlOnph9i7vQhHhsrXYwdyoHxM6N7Jw";
...
document.getElementById("enter").addEventListener("click", () => {
  window.location.href = "earthbound.html";
});
